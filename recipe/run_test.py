...
COPIED FROM pywintypes.py from the pywin32 distribution, do not merge this! This file exists solely to see
if we can figure out why the package seems broken but the tests for the package pass.
...
def __import_pywin32_system_module__(modname, globs):
    print('started looking for', modname)
    ...
    print('found pywintypes dll at', found)
    return
